...
import plot_vcg_v11_nested_all_baselines_89k as subject


class ReductionTests(unittest.TestCase):
    def test_exactly_six_requested_methods(self):
        self.assertEqual(len(subject.METHOD_SPECS), 6)
        self.assertEqual(subject.METHOD_SPECS[0][0], "lambda0")
        self.assertEqual(subject.METHOD_SPECS[1][0], "lambda02")
                ...
                rows.append(
                    {
                        ...
                        "dense_return": float(seed - 89000 + model),
